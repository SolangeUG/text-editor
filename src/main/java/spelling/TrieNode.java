...
class TrieNode {
	 ...
	 * @param text the string to store in the new node
	 */
	 ...
	 * @return The TrieNode that character links to,
	 * 		   or null if that link is not in the trie.
	 */
	 ...
	 * @return The newly created TrieNode,
	 * 		   or null if the node is already in the trie.
	 */
	 ...
	 * @return the text stored at this node
	 */
	 ...
	 * @param b value that determines whether this node ends a word or not
	 */
	 ...
	 * @return true if this node ends a word in the dictionary
	 * 		   false otherwise
	 */
	 ...
	 * @return the set of characters linked from this node
	 */
	...
	/**
	 * Return a collection of all TrieNode children of this node
	 * @return an iterable collection of this node's children
	 */
