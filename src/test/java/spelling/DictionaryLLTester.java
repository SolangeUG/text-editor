...
/**
 * JUnit tests for the DictionaryLL class
 * @author UC San Diego MOOC team
 * @author Solange U. Gasengayire
 */
class DictionaryLLTester {
	...
	private DictionaryLL emptyDict;
	 ...
	 */
	@Test
	@DisplayName("Test size method of dictionary as a linked list")
	void testSize() {
	 ...
	 */
	@Test
	@DisplayName("Test isWord method of dictionary as a linked list")
	void testIsWord() {
	 ...
	 */
	@Test
	@DisplayName("test addWord method of dictionary as a linked list")
	void addWord() {
